...
export const featuredProjects: FeaturedProject[] = [
  {
    ...
    description:
      "Frontend publicado em JavaScript, JSX, CSS, JSON de idiomas e HTML, com React, Vite, React DOM, Motion e i18next. Usa Fetch API, LocalStorage e tokens CSS para temas e customização, integrado à API REST histórica em Java 21 e Spring Boot 3.4.5 com JPA, Security, PostgreSQL, H2 e JWT.",
    tags: [
      "JavaScript",
      "JSX",
      "CSS",
...
export const allProjects: TableProject[] = [
  {
    ...
    title: "Sistema de Controle Financeiro",
    description:
      "Frontend desacoplado publicado em JavaScript, JSX, CSS, JSON de idiomas e HTML com React, Vite, React DOM, Motion e i18next; inclui Fetch API, LocalStorage e tokens CSS para temas e customização, integrado à API REST histórica em Java 21 e Spring Boot 3.4.5 com JPA, Security, PostgreSQL, H2 e JWT",
    year: 2026,
    stage: "PROTÓTIPO",
    link: "https://financial-control-dashboard-smoky.vercel.app",
  },

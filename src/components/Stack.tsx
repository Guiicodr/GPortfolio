...
const stackData: StackCategory[] = [
  {
    ...
    items: [
      ...
      { name: "JavaScript / JSX", level: "Avançado" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "React 19", level: "Componentes e Hooks" },
      { name: "React DOM", level: "Renderização web" },
      { name: "Next.js 16", level: "App Router, SSR, SSG" },
      { name: "Vite 8", level: "Build e desenvolvimento frontend" },
      { name: "Tailwind CSS 4", level: "Design system utility-first" },
      { name: "React Icons", level: "Iconografia de interfaces" },
      { name: "Recharts", level: "Gráficos e relatórios" },
      { name: "Motion", level: "Animações de interface" },
      { name: "OGL", level: "Experiências WebGL" },
      { name: "i18next / react-i18next", level: "Internacionalização" },
    ],
  },
  {
    category: "FERRAMENTAS & PLATAFORMAS",
    items: [
      { name: "ESLint", level: "Qualidade e padrões de código" },
      { name: "Vite React plugin", level: "Integração React com Vite" },
      { name: "Fetch API", level: "Comunicação com APIs" },
      { name: "LocalStorage", level: "Persistência local" },
      { name: "CSS tokens", level: "Temas e customização" },
